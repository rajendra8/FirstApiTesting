...
//		apiUrl = prop.getProperty("serviceURL");
		apiUrl=prop.getProperty("LocusBookListPara");
	...
	public void getAPITestWithoutHeaders() throws ClientProtocolException, IOException{
		...
		//per_page:
		String perPageValue = TestUtil.getValueByJPath(responseJson, "/items/total");
		System.out.println("value of books is-->"+ perPageValue);
